...
public class UserService implements UserDetailsService {
   ...
   // private final ClassRepository classRepository;  decommenter aprés
   // private final InstitutionRepository institutionRepository;  decommenter aprés
    ...
    public UserService(UserRepository userRepository, @Lazy PasswordEncoder encoder, EmailService emailService, IPhotoService iPhotoService, @Lazy IAuthService iAuthService, VerificationTokenRepository verificationTokenRepository, MongoTemplate mongoTemplate, SearchRepository searchRepository, DeviceMetadataRepository deviceMetadataRepository, RestTemplate restTemplate) {
       // ClassRepository classRepository, InstitutionRepository institutionRepository) decommenter aprés teb3a l ligne 62
      ...
      //  this.classRepository = classRepository;  decommenter aprés
     //   this.institutionRepository = institutionRepository; decommenter aprés
    ...
    public UserDTO getMyInfo(String email) {
        ...
        return new UserDTO(
                ...
                user.getSecurity(),
                user.getProfile(),
          //      user.getEducation(),   decommenter aprés
                user.getContact(),
                user.getActivity(),
                user.getSettings(),
                user.getScore()
