...
public class UserDTO {
    ...
    // private UserEducationDTO education;  decommenter aprés
    ...
    public UserDTO(
            ...
            UserProfile profile,
         //   UserEducationalDetails education, decommenter aprés
            UserContact contact,
    ...
    )
    {
     ...
     //   this.education = new UserEducationDTO(education);   decommenter aprés
