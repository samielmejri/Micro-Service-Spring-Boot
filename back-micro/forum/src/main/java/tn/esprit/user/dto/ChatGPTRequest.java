...
public class ChatGPTRequest {
    ...
    public ChatGPTRequest(String model, String prompt) {
        ...
        this.messages.add(new Message("system",
                "**Analyze the plain text (excluding images, videos, or blobs)  and surrounding context of the user's input to determine if it contains any of the following harmful elements:**\n" +
                        "\n" +
